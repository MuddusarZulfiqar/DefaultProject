...
<div class="content-wrapper sell-page">
    <div class="pageHead">
        <div class="container">
            <h1>Sell <span>With Us</span></h1>
        </div>
    </div>
    <div class="container-md">
        <div class="row  align-items-center" >
            <div class="col-sm-6">
                <h2>
                    Sell your <br/> <span>property with Us</span>
                </h2>
                <p>
            ...
            <div class="col-sm-6">
                <div class="image">
                    <img src="src/images/sell_page.png" alt="" class="img-fluid">
                </div>
            </div>
        </div>
